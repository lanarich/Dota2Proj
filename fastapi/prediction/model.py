...
columns_with_leaver_status = [
    'dire_POSITION_4_leaverStatus',
    'radiant_POSITION_3_leaverStatus',
    'radiant_POSITION_2_leaverStatus',
    'dire_POSITION_5_leaverStatus',
    'dire_POSITION_3_leaverStatus',
    'dire_POSITION_2_leaverStatus',
    'dire_POSITION_1_leaverStatus',
    'radiant_POSITION_4_leaverStatus',
    'radiant_POSITION_5_leaverStatus',
    'radiant_POSITION_1_leaverStatus']
...
def dataframe_preprocessing(dataframe, predict_items=False):
    ...
    print(
        start,
        "| info | начало | предобработка информации из датафрейма\
            | match_id : ",
        dataframe.loc['id'])
    ...
    print(
        ...
        "| info | конец | предобработка информации из датафрейма\
            | match_id : ",
        dataframe.loc['id'])
    return dataframe
